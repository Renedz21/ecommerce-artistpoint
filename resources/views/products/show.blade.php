        ...
        <div
            ...
            <div class="-mt-10">
                ...
                <dl class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
                    <div class="border-t border-b mb-4 border-gray-200 p-4">
                        <dt class="font-medium text-gray-900">Marca</dt>
                        <dd class="mt-2 text-base text-indigo-500 underline capitalize hover:text-indigo-800"><a
                                href="">{{ $product->brand->name }}</a>
                        </dd>
                    </div>

                    <div class="border-t border-b mb-3 border-gray-200 p-4">
                        <dt class="font-medium text-gray-900">Categoria</dt>
                ...
                <div class="bg-white rounded-lg shadow-lg mt-2 mb-4">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-indigo-700 font-semibold text-sm">Recibel el
